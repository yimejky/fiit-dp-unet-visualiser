...
arch.extend([
    to_Conv("middle_conv1", '', 64, offset="(1,0,0)", to=f"(pool3-east)", height=height_init, depth=height_init, width=max_width+width_offset),
    to_Conv("middle_conv2", '', 128, offset="(0,0,0)", to=f"(middle_conv1-east)", height=height_init, depth=height_init, width=max_width*width_scaller+width_offset)
])
